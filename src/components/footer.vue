    ...
    <div class="border-top next-prev-pages mt-16 pt-6 d-flex flex-warp justify-space-between">
        ...
        <span style="">
            <router-link v-if="$route.meta.prev" :to="{ name: $route.meta.prev.link }" class=" previous py-5 px-4 px-md-8 px-lg-10">
                <span>
                    ...
                    <span class="primary-text fw-500">Previous</span>
                </span>
                <span class="muted-text fw-400 smaller mt-2 mr-1">{{ $route.meta.prev.text }}</span>
            </router-link>
        </span>
        ...
        <span style="">
            <router-link v-if="$route.meta.next" :to="{ name: $route.meta.next.link }" class="next py-5 px-4 px-md-8 px-lg-10">
                ...
                <span class="muted-text fw-400 smaller mt-2 mr-1">{{ $route.meta.next.text }}</span>
            </router-link>
        </span>
...
a {
    ...
    &:hover {
        ...
        -webkit-box-shadow: 0 0 0 0px rgb(21 91 255 / 100%);
        box-shadow: 0 0 0 0px rgb(21 91 255 / 100%);
    }
}
</style>